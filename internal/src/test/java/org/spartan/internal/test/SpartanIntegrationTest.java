...
public class SpartanIntegrationTest {
    ...
    class UnitTests {
        ...
        void testConfigLayoutConstants() {
            ...
            assertEquals(100, SpartanConfigLayout.RSAC_TRUNCATED_BPTT_DEPTH_OFFSET);
            assertEquals(432, SpartanConfigLayout.RSAC_CONFIG_TOTAL_SIZE);
            assertEquals(496, SpartanConfigLayout.CURIOSITY_RSAC_CONFIG_TOTAL_SIZE);
