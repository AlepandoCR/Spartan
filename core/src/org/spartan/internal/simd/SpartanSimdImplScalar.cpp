...
namespace org::spartan::internal::simd::implementations {
    ...
    namespace scalar {
        ...
        void store(double* ptr, const SimdFloat &value) {
            ptr[0] = value.data[0];
        }

        SimdFloat add(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
            result.data[0] = a.data[0] + b.data[0];
            return result;
        }

        SimdFloat subtract(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
            result.data[0] = a.data[0] - b.data[0];
            return result;
        }

        SimdFloat multiply(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
            result.data[0] = a.data[0] * b.data[0];
            return result;
        }

        SimdFloat divide(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
            result.data[0] = a.data[0] / b.data[0];
            return result;
        }

        SimdFloat fusedMultiplyAdd(const SimdFloat &mul1, const SimdFloat &mul2, const SimdFloat &add) {
            SimdFloat result{};
            result.data[0] = (mul1.data[0] * mul2.data[0]) + add.data[0];
            return result;
        }

        SimdFloat maximum(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
            result.data[0] = std::max(a.data[0], b.data[0]);
            return result;
        }

        SimdFloat minimum(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
        ...
        SimdFloat broadcast(const double scalar) {
            SimdFloat result{};
            result.data[0] = scalar;
            return result;
        }

        double horizontalSum(const SimdFloat &value) {
            return value.data[0];
        }

        SimdFloat sqrt_op(const SimdFloat &value) {
            SimdFloat result{};
            result.data[0] = std::sqrt(value.data[0]);
            return result;
        }

        SimdFloat abs_op(const SimdFloat &value) {
            SimdFloat result{};
            result.data[0] = std::abs(value.data[0]);
            return result;
        }

        SimdFloat compareGreaterThan(const SimdFloat &a, const SimdFloat &b) {
            SimdFloat result{};
            result.data[0] = a.data[0] > b.data[0] ? 1.0 : 0.0;
            return result;
        }

        SimdFloat blend(const SimdFloat &trueValue, const SimdFloat &falseValue, const SimdFloat &mask) {
            SimdFloat result{};
